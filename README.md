...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/swapi_search_people \
  -H 'Content-Type: application/json' \
  -d '{"query":"Luke"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/swapi_search_people`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
